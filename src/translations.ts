...
plan: {
  ...
  noSavedJobsText: "Save jobs from the matches list and they will appear here.",
    ...
    postJobPage: {
      ...
      maxExperienceLessThanMinError: "Maximum experience cannot be lower than minimum experience.",
    },
...
jobMatches: {
  ...
  noSavedJobsText: "احفظ الوظائف من قائمة التطابقات وستظهر هنا.",
    ...
    postJobPage: {
      ...
      maxExperienceLessThanMinError: "لا يمكن أن يكون الحد الأقصى للخبرة أقل من الحد الأدنى.",
    },
...
companyApplicationsPage: {
  ...
  noSavedJobsText: "שמור משרות מרשימת ההתאמות והן יופיעו כאן.",
    ...
    postJobPage: {
      ...
      maxExperienceLessThanMinError: "ניסיון מקסימלי לא יכול להיות נמוך מניסיון מינימלי.",
    },
