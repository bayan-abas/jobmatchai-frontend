...
profileBox: {
  ...
  completeSubtitle: "Great job! Your profile is fully filled out.",
  uploadResume: "Upload Resume",
  editProfile: "Edit Profile",
...
profileBox: {
  title: "أكمل ملفك الشخصي",
  subtitle: "أضف تفاصيل أكثر لتحسين نسبة المطابقة",
  completeTitle: "الملف الشخصي مكتمل!",
  completeSubtitle: "عمل رائع! تم ملء ملفك الشخصي بالكامل.",
  uploadResume: "رفع السيرة الذاتية",
  editProfile: "تعديل الملف الشخصي",
...
profileBox: {
  ...
  completeTitle: "הפרופיל הושלם!",
  completeSubtitle: "עבודה מצוינת! הפרופיל שלך מלא לגמרי.",
  uploadResume: "העלה קורות חיים",
  editProfile: "ערוך פרופיל",
