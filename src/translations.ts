...
export const translations: Record<Language, any> = {
  en: {
    common: {
      ...
      no: "No",
      loading: "Loading...",
      reconnecting: "Reconnecting to the server... this can take up to a minute after a period of inactivity.",
      retry: "Retry",
      status: "Status",
      active: "Active",
      inactive: "Inactive",
    ...
    dashboard: {
      ...
      noCvTitle: "No CV uploaded yet",
      noCvSubtitle: "Upload your CV to start receiving AI match scores",
      stats: {
        jobMatches: "Job Matches",
        applications: "Applications",
...
plan: {
  ...
  loadError: "Could not load jobs from the backend. Please try again.",
  ...
  matchScoreErrorRetry: "Couldn't compute - tap to retry",
  ...
  noSavedJobsText: "Save jobs from the matches list and they will appear here.",
    ...
    applicationsPage: {
      ...
      jobClosedNotice: "This job posting is no longer active.",
    ...
    externalJobsPage: {
      ...
      matchScoreUnavailable: "Couldn't compute a match for this job yet.",
      matchScoreErrorRetry: "Couldn't compute - tap to retry",
    ...
    jobDetails: {
      ...
      externalJobBadge: "External Job",
      closedBadge: "Closed",
      jobClosedMessage: "This job is no longer accepting applications.",
      ...
      requiredSkillsMatchedSuffix: "required skills matched",
      ...
      matchStatusLow: "Low Match",
      lastAnalyzed: "Last analyzed",
      transparencyNote:
        "This match score is based on comparing your CV with this job's requirements — skills, experience, education, and other qualifications.",
      requiredLabel: "Required",
      experienceLevelEntry: "Entry level",
      experienceLevelMid: "Mid level",
      experienceLevelSenior: "Senior level",
      educationLevelAnyDegree: "Any degree",
      educationLevelRelevantDegree: "A relevant degree",
      certificationLevelGeneral: "A general certification",
      certificationLevelSpecific: "A specific professional license/certification",
      locationMatchExplanation: "Based on whether this job's location/work arrangement matches your preferences.",
      languageMatchExplanation: "Based on the language proficiency your CV shows compared to what this role needs.",
      skillModal: {
    ...
    companyJobPostingsPage: {
      ...
      closeJobConfirm:
        "This job will stop accepting new applications and disappear from candidates' available jobs list. You can reopen it at any time.",
      closing: "Closing...",
      reopening: "Reopening...",
      failedToCloseJob: "Failed to close job.",
      failedToReopenJob: "Failed to reopen job.",
    ...
    postJobPage: {
      ...
      serverConnectionFailed: "Server connection failed.",
      negativeValueNotAllowed: "Please enter a value of 0 or greater.",
      maxSalaryLessThanMinError: "Maximum salary cannot be lower than minimum salary.",
    },
  ...
  ar: {
    common: {
      ...
      reconnecting: "جارٍ إعادة الاتصال بالخادم... قد يستغرق هذا حتى دقيقة بعد فترة من عدم النشاط.",
    ...
    dashboard: {
      ...
      noCvTitle: "لم يتم رفع السيرة الذاتية بعد",
      noCvSubtitle: "ارفع سيرتك الذاتية للبدء في تلقّي نسب التطابق المدعومة بالذكاء الاصطناعي",
      stats: {
        jobMatches: "الوظائف المطابقة",
        applications: "الطلبات",
...
jobMatches: {
  ...
  loadError: "تعذّر تحميل الوظائف من الخادم. يرجى المحاولة مرة أخرى.",
  ...
  matchScoreErrorRetry: "تعذّر الحساب - اضغط لإعادة المحاولة",
  ...
  noSavedJobsText: "احفظ الوظائف من قائمة التطابقات وستظهر هنا.",
    ...
    applicationsPage: {
      ...
      jobClosedBadge: "مغلقة",
      jobClosedNotice: "هذه الوظيفة لم تعد نشطة.",
    ...
    externalJobsPage: {
      ...
      matchScoreUnavailable: "تعذّر حساب التوافق لهذه الوظيفة حتى الآن.",
      matchScoreErrorRetry: "تعذّر الحساب - اضغط لإعادة المحاولة",
    ...
    jobDetails: {
      ...
      closedBadge: "مغلقة",
      jobClosedMessage: "لم تعد هذه الوظيفة تقبل الطلبات.",
      externalJobBadge: "وظيفة خارجية",
      ...
      requiredSkillsMatchedSuffix: "من المهارات المطلوبة متطابقة",
      ...
      matchStatusLow: "تطابق منخفض",
      lastAnalyzed: "آخر تحليل",
      transparencyNote:
        "تعتمد نسبة التطابق هذه على مقارنة سيرتك الذاتية بمتطلبات هذه الوظيفة — المهارات والخبرة والتعليم والمؤهلات الأخرى.",
      requiredLabel: "المطلوب",
      experienceLevelEntry: "مستوى مبتدئ",
      experienceLevelMid: "مستوى متوسط",
      experienceLevelSenior: "مستوى كبير/خبير",
      educationLevelAnyDegree: "أي شهادة جامعية",
      educationLevelRelevantDegree: "شهادة جامعية ذات صلة",
      certificationLevelGeneral: "شهادة عامة",
      certificationLevelSpecific: "ترخيص أو شهادة مهنية محددة",
      locationMatchExplanation: "بناءً على مدى تطابق موقع/نمط عمل هذه الوظيفة مع تفضيلاتك.",
      languageMatchExplanation: "بناءً على مستوى إتقان اللغة الظاهر في سيرتك الذاتية مقارنة بما تتطلبه هذه الوظيفة.",
      skillModal: {
    ...
    companyJobPostingsPage: {
      ...
      reopenJob: "إعادة فتح الوظيفة",
      closeJobConfirm:
        "ستتوقف هذه الوظيفة عن قبول طلبات جديدة وستختفي من قائمة الوظائف المتاحة للمرشحين. يمكنك إعادة فتحها في أي وقت.",
      closing: "جارٍ الإغلاق...",
      reopening: "جارٍ إعادة الفتح...",
      failedToCloseJob: "فشل إغلاق الوظيفة.",
      failedToReopenJob: "فشل إعادة فتح الوظيفة.",
    ...
    postJobPage: {
      ...
      levelSenior: "خبير",
      levelLead: "قائد فريق",
      minExperienceYears: "الحد الأدنى للخبرة (سنوات)",
      experiencePlaceholder: "مثال: 2",
      min: "الحد الأدنى",
      max: "الحد الأقصى",
      requiredSkills: "المهارات المطلوبة",
...
companyApplicationsPage: {
  ...
  he: {
    common: {
      ...
      no: "לא",
      loading: "טוען...",
      reconnecting: "מתחבר מחדש לשרת... זה עשוי לקחת עד דקה לאחר תקופת חוסר פעילות.",
      retry: "נסה שוב",
      status: "סטטוס",
      active: "פעיל",
      inactive: "לא פעיל",
    ...
    dashboard: {
      ...
      noCvTitle: "טרם הועלו קורות חיים",
      noCvSubtitle: "העלה את קורות החיים שלך כדי להתחיל לקבל ציוני התאמה מבוססי בינה מלאכותית",
      stats: {
        jobMatches: "משרות מתאימות",
        applications: "הגשות",
        interviews: "ראיונות",
  ...
  loadError: "לא ניתן לטעון משרות מהשרת. אנא נסה שוב.",
  ...
  matchScoreErrorRetry: "לא ניתן לחשב - הקש כדי לנסות שוב",
  ...
  noSavedJobsText: "שמור משרות מרשימת ההתאמות והן יופיעו כאן.",
    ...
    applicationsPage: {
      ...
      jobClosedBadge: "סגורה",
      jobClosedNotice: "משרה זו כבר לא פעילה.",
    ...
    externalJobsPage: {
      ...
      matchScoreUnavailable: "לא ניתן היה לחשב התאמה למשרה זו עדיין.",
      matchScoreErrorRetry: "לא ניתן לחשב - הקש כדי לנסות שוב",
    ...
    jobDetails: {
      ...
      requiredSkillsMatchedSuffix: "מהכישורים הנדרשים תואמים",
      ...
      matchStatusLow: "התאמה נמוכה",
      lastAnalyzed: "נותח לאחרונה",
      transparencyNote:
        "ציון ההתאמה מבוסס על השוואה בין קורות החיים שלך לדרישות המשרה — כישורים, ניסיון, השכלה ומאפיינים נוספים.",
      requiredLabel: "נדרש",
      experienceLevelEntry: "רמת התחלתית",
      experienceLevelMid: "רמת ביניים",
      experienceLevelSenior: "רמה בכירה",
      educationLevelAnyDegree: "כל תואר אקדמי",
      educationLevelRelevantDegree: "תואר אקדמי רלוונטי",
      certificationLevelGeneral: "הסמכה כללית",
      certificationLevelSpecific: "רישיון או הסמכה מקצועית ספציפית",
      locationMatchExplanation: "מבוסס על מידת ההתאמה בין מיקום/אופן העבודה של המשרה להעדפותיך.",
      languageMatchExplanation: "מבוסס על רמת שליטת השפה המופיעה בקורות החיים שלך בהשוואה לנדרש בתפקיד.",
      skillModal: {
    ...
    companyJobPostingsPage: {
      ...
      closedJobs: "סגורה",
      closeJob: "סגור משרה",
      reopenJob: "פתח משרה מחדש",
      closeJobConfirm:
        "משרה זו תפסיק לקבל בקשות חדשות ותיעלם מרשימת המשרות הזמינות למועמדים. תוכל לפתוח אותה מחדש בכל עת.",
      closing: "סוגר...",
      reopening: "פותח מחדש...",
      failedToCloseJob: "סגירת המשרה נכשלה.",
      failedToReopenJob: "פתיחת המשרה מחדש נכשלה.",
      applicants: "מועמדים",
      viewCandidates: "צפה במועמדים",
      viewDetails: "צפה בפרטים",
      editJob: "ערוך משרה",
    ...
    postJobPage: {
      ...
      minExperienceYears: "ניסיון מינימלי (שנים)",
      experiencePlaceholder: "לדוגמה: 2",
      min: "מינימום",
      max: "מקסימום",
      requiredSkills: "כישורים נדרשים",
      ...
      serverConnectionFailed: "החיבור לשרת נכשל.",
      negativeValueNotAllowed: "יש להזין ערך 0 ומעלה.",
      maxSalaryLessThanMinError: "שכר מקסימלי לא יכול להיות נמוך משכר מינימלי.",
    },
